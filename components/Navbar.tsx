    ...
    return (
        ...
        {isMobileSearchOpen && (
            <>
                ...
                <div 
                    ref={searchSheetRef}
                    className="fixed left-0 right-0 top-0 z-50 sm:hidden bg-background rounded-b-2xl flex flex-col max-h-[90vh] animate-in slide-in-from-top-10 duration-300 pt-3"
                    ...
                    onTouchEnd={(e) => {
                        ...
                        // Auto-close if dragged up 100px
                        if (dragDistance < -100) {
