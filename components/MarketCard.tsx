        ...
        <>
            ...
            >
                <div className="space-y-3">
                    ...
                    <div className="flex gap-3">
                        <div className="flex-1 px-3 py-2 bg-green-950/30 border border-green-900/40 rounded-lg transition-all duration-300 group-hover:border-green-700/50">
                            <div className="flex items-baseline justify-between gap-2">
                                <span className="text-xs font-medium text-green-400">Yes</span>
                                <div className="text-right">
                                    <div className="text-sm font-bold text-green-300 prob-animate">{market.yes_probability}%</div>
                                    <div className="text-[10px] text-green-400/70 font-semibold">{yesOdds}x</div>
                                </div>
                            </div>
                        </div>
                        <div className="flex-1 px-3 py-2 bg-red-950/30 border border-red-900/40 rounded-lg transition-all duration-300 group-hover:border-red-700/50">
                            <div className="flex items-baseline justify-between gap-2">
                                <span className="text-xs font-medium text-red-400">No</span>
                                <div className="text-right">
                                    <div className="text-sm font-bold text-red-300 prob-animate">{noProbability}%</div>
                                    <div className="text-[10px] text-red-400/70 font-semibold">{noOdds}x</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            >
                ...
                <div className="market-card-outcomes flex gap-3 mb-4">
                    {/* Yes Box */}
                    <div className="flex-1 px-3 py-3 bg-green-950/30 border border-green-900/40 rounded-lg transition-all duration-300 hover:border-green-700/60 group-hover:border-green-700/50">
                        <div className="flex flex-col items-center gap-1.5">
                            <span className="text-xs font-medium text-green-400">Yes</span>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-green-300 prob-animate">{market.yes_probability}%</div>
                                <div className="text-xs text-green-400/70 font-semibold mt-0.5">{yesOdds}x</div>
                            </div>
                        </div>
                    </div>
                    
                    {/* No Box */}
                    <div className="flex-1 px-3 py-3 bg-red-950/30 border border-red-900/40 rounded-lg transition-all duration-300 hover:border-red-700/60 group-hover:border-red-700/50">
                        <div className="flex flex-col items-center gap-1.5">
                            <span className="text-xs font-medium text-red-400">No</span>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-red-300 prob-animate">{noProbability}%</div>
                                <div className="text-xs text-red-400/70 font-semibold mt-0.5">{noOdds}x</div>
                            </div>
                        </div>
                    </div>
                </div>
