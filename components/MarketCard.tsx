...
export default function MarketCard({ market }: MarketCardProps) {
  ...
  return (
    <Link
      ...
      className="group block overflow-hidden rounded-3xl border border-border bg-muted p-3 md:p-4 shadow-sm dark:shadow-lg backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:border-border/80 hover:bg-muted/80 hover:shadow-md dark:hover:shadow-xl active:scale-[0.99] h-[220px]"
    >
